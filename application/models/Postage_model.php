...
class Postage_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('id', $q);
	$this->db->or_like('first_district_id', $q);
	$this->db->or_like('last_district_id', $q);
	$this->db->or_like('emount', $q);
...
/* End of file Postage_model.php */
/* Location: ./application/models/Postage_model.php */

      ...
      <section class='content'>
	    ...
	    <tbody>
			...
			echo '  '; 
			echo anchor(site_url('index.php/warehouse/update/'.$warehouse->id),'<i class="fa fa-edit"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm')); 
			echo '  '; 
			echo anchor(site_url('index.php/warehouse/delete/'.$warehouse->id),'<i class="fa fa-trash-alt"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php

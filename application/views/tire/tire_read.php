<!-- Main content -->
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Noseri <?php echo form_error('noseri') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="noseri" id="noseri" placeholder="Noseri" value="<?php echo $noseri; ?>" disabled/>
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Stock <?php echo form_error('stock') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="stock" id="stock" placeholder="Stock" value="<?php echo $stock; ?>" disabled/>
                                   </div> 
                                </div>
	 ...
	 <div style='text-align: right;'>
	    <a href="<?php echo site_url('index.php/tire') ?>" class="btn btn-default">Cancel</a>
	</div>
                        </div>
                    </div>
                  </div>

...
class Handover extends CI_Controller
{
    ...
    public function create() 
    {
        $data = array(
            ...
            'get_all_kode' => $this->Delivery_model->get_all_kode_by_rcstatus("receive by customer"),
	);
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
              ...
              'receive_customer_status' => 'receive by customer'
            );
    ...
    public function deleteAll($id){
       $data = array(
              'received_date' => '',
              'receive_customer_status' => 'on the way'
            );

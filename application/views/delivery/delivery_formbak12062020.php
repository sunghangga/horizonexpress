                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                   <input type="hidden" class="form-control" name="name_penerima" id="name_penerima" placeholder="Name Penerima" value="<?php echo $name_penerima; ?>" required/>
                                  </div>
                                </div>
                          ...
                          <div style="display: none;" id="custom-content-below-profile">
                            ...
                            <div class="row">
                             <div class="row">
                              ...
                              <div class="col-2 faktur">
                                ...
                                <?php }?>
                                  <div class="col-sm">
                                    <input type="text" class="form-control faktur-item" autocomplete="off" spellcheck="false" name="faktur_item[]" id="faktur_item1" rel="rel_faktur_item1" placeholder="Faktur" value="<?php echo $row->faktur;?>" required/>
                              ...
                              <div class="col-2 faktur">
                                <div class="form-group">
                                  <label for="staticEmail" class="col-12 col-form-label">Faktur</label>
                                  <div class="col-sm">
                                    <input type="text" class="form-control faktur-item" spellcheck="false" name="faktur_item[]" id="faktur_item1" rel="rel_faktur_item1" placeholder="Faktur" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-1">
                                <div class="form-group">
                                  <label for="staticEmail" class="col-12 col-form-label">Qty </label>
                                  <div class="col-sm">
                                    <input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_item[]" id="qty_item1" rel="rel_qty_item1" value="1" readonly/>
                                  </div>
                                </div>
                              </div>
                              <div class="col-2">
                            ...
                            <?php }?>
                              ...
                              foreach ($get_delivery_detail_by_id as $row) {
                               ...
                               ?>
                              <?php if ($iter != 0) { ?>
                                 <div><div class="row motor">
                                  <div class="col-2 faktur">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="text" class="form-control faktur-item" autocomplete="off" spellcheck="false" name="faktur_item[]" id="<?php echo 'faktur_item'.($iter+1); ?>" rel="<?php echo 'rel_faktur_item'.($iter+1); ?>" placeholder="Faktur" value="<?php echo $row->faktur; ?>" required/>
      ...
      <script>
        $(document).ready(function(){
          ...
          $("#add_item").on("click", function(e) {
            ...
            '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="text" class="form-control faktur-item" autocomplete="off" spellcheck="false" name="faktur_item[]" id="faktur_item'+counterB+'" rel="rel_faktur_item'+counterB+'" placeholder="Faktur" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
            ...
            $('.name-item').on("focus", function(){
              $("input[rel^='rel_name_item']").autocomplete({
                source: "<?php echo base_url()?>delivery/get_item/motor",
                select: function (event, ui) {
                  var tar = event.target.id;
                  tar = tar.substr(tar.length - 1);
          ...
          $("#add_other").on("click", function(e) {
            ...
            html_list += '<div><div class="row">'+
              ...
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="number" class="form-control" autocomplete="off" spellcheck="false" name="price_other[]" id="price_other'+counterB+'" rel="rel_price_other'+counterB+'" placeholder="Price Other" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +

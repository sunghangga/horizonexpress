                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                   <input type="text" class="form-control" name="name_penerima" id="name_penerima" placeholder="Name Penerima" value="<?php echo $name_penerima; ?>" required/>
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                   <input type="text" class="form-control" name="telephone_penerima" id="telephone_penerima" placeholder="Telephone Penerima" value="<?php echo $telephone_penerima; ?>" required/>
                                  </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                   <select class="form-control select2bs4" onchange="districts_list()" name="regencies_id" id="regencies_id" placeholder="Regencies" value="<?php echo $regencies_id; ?>" />
                                    ...
                                    if($regencies_id != null){ 
                                         echo '<option value="'.$regencies_id.'">'.$regencies_name.'</option>';
                                    } 
                                    foreach ($get_regencies as $row)
                                        {
                                          if($regencies_id != $row->id){
                                            echo '<option value="'.$row->id.'">'.$row->name.'</option>';
                                          }
                                        } 
                                    ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                   <select class="form-control select2bs4" name="villages_id" id="villages_id" placeholder="Villages" value="<?php echo $villages_id; ?>" />
                                    <?php 
                                    if($villages_id != null){ 
                                         echo '<option value="'.$villages_id.'">'.$villages_name.'</option>';
                                    } 
                                    foreach ($get_villages as $row)
                                        {
                                          if($villages_id != $row->id){
                                            echo '<option value="'.$row->id.'">'.$row->name.'</option>';
                                          }
                                        } 
                                    ?>
                            ...
                            <div class="row">
                             <div class="row">
                              ...
                              <div class="col-2">
                                ...
                                <?php }?>
                                  <div class="col-sm">
                                    <input type="text" class="form-control name-item" autocomplete="off" spellcheck="false" name="name_item[]" id="name_item1" rel="rel_name_item1" placeholder="Name Item" value="<?php echo $row->name;?>" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-2">
                                ...
                                <?php }?>
                                  <div class="col-sm">
                                    <input type="text" class="form-control nomesin-item" autocomplete="off" spellcheck="false" name="nomesin_item[]" id="nomesin_item1" rel="rel_nomesin_item1" placeholder="no. Mesin" value="<?php echo $row->no_mesin;?>" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-2">
                                ...
                                <?php }?>
                                  <div class="col-sm">
                                    <input type="text" class="form-control norangka-item" autocomplete="off" spellcheck="false" name="norangka_item[]" id="norangka_item1" rel="rel_norangka_item1" placeholder="No. rangka" value="<?php echo $row->no_rangka;?>" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <?php }?>
                                  <div class="col-sm">
                                    <input type="number" class="form-control price-item" autocomplete="off" spellcheck="false" name="price_item[]" id="price_item" rel="rel_price_item" placeholder="Price Item" value="<?php echo $row->price;?>" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-1">
                                <div class="form-group">
                                  ...
                                  <?php }?>
                                  <div class="col-sm">
                                    <input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_item[]" id="qty_item1" rel="rel_qty_item1" placeholder="Qty" value="<?php echo $row->qty;?>" required/>
                                  </div>
                                </div>
                              </div>
                              <div class="col-3">
                                  ...
                                  <div class="col-sm">
                                    <div class="row">
                                      <div class=".col-12 .col-sm-6 .col-lg-8">
                                        <input type="text" class="form-control" autocomplete="off" spellcheck="false" name="unit_item[]" id="unit_item1" rel="rel_unit_item1" placeholder="Unit" value="<?php echo $row->unit;?>" required/>
                                      </div>
                              ...
                              <div class="col-2">
                                <div class="form-group">
                                  <label for="staticEmail" class="col-12 col-form-label">Name</label>
                                  <div class="col-sm">
                                    <input type="text" class="form-control name-item" autocomplete="off" spellcheck="false" name="name_item[]" id="name_item1" rel="rel_name_item1" placeholder="Name Item" required/>
                                  </div>
                                </div>
                              </div>
                              <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                    <input type="text" class="form-control nomesin-item" 
                                     spellcheck="false" name="nomesin_item[]" id="nomesin_item1" rel="rel_nomesin_item1" placeholder="No. Mesin" required/>
                                  </div>
                                </div>
                              </div>
                              <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                    <input type="text" class="form-control norangka-item"
                                     spellcheck="false" name="norangka_item[]" id="norangka_item1" rel="rel_norangka_item1" placeholder="No. Rangka" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-2">
                                <div class="form-group">
                                  <label for="staticEmail" class="col-12 col-form-label">Price</label>
                                  <div class="col-sm">
                                    <input type="number" class="form-control price-item" autocomplete="off" spellcheck="false" name="price_item[]" id="price_item" rel="rel_price_item" placeholder="Price Item" required/>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="col-1">
                                <div class="form-group">
                                  <label for="staticEmail" class="col-12 col-form-label">Qty </label>
                                  <div class="col-sm">
                                    <input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_item[]" id="qty_item1" rel="rel_qty_item1" value="1" />
                                  </div>
                                </div>
                              </div>
                              <div class="col-3">
                              ...
                              <?php if ($iter != 0) { ?>
                                 <div><div class="row">
                                  <div class="col-2">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="text" class="form-control name-item" autocomplete="off" spellcheck="false" name="name_item[]" id="<?php echo 'name_item'.($iter+1); ?>" rel="<?php echo 'rel_name_item'.($iter+1); ?>" placeholder="Name Item" value="<?php echo $row->name; ?>" required/>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-2">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="text" class="form-control nomesin-item" autocomplete="off" spellcheck="false" name="nomesin_item[]" id="<?php echo 'nomesin_item'.($iter+1); ?>" rel="<?php echo 'rel_nomesin_item'.($iter+1); ?>" placeholder="No. Mesin" value="<?php echo $row->no_mesin; ?>" required/>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-2">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="text" class="form-control norangka-item" autocomplete="off" spellcheck="false" name="norangka_item[]" id="<?php echo 'norangka_item'.($iter+1); ?>" rel="<?php echo 'rel_norangka_item'.($iter+1); ?>" placeholder="No. Rangka" value="<?php echo $row->no_rangka; ?>" required/>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-2">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="number" class="form-control name-item" autocomplete="off" spellcheck="false" name="price_item[]" id="<?php echo 'price_item'.($iter+1); ?>" rel="<?php echo 'rel_price_item'.($iter+1); ?>" placeholder="Price Item" value="<?php echo $row->price; ?>" required/>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-1">
                                    <div class="form-group">
                                      <div class="col-sm">
                                        <input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_item[]" id="<?php echo 'qty_item'.($iter+1); ?>" rel="<?php echo 'rel_qty_item'.($iter+1); ?>" placeholder="Qty" value="<?php echo $row->qty; ?>" required/>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-3"> 
                                    <div class="form-group"> 
                                      <div class="col-sm">
                                        <div class="row">
                                          <div class=".col-12 .col-sm-6 .col-lg-8"> 
                                            <input type="text"  class="form-control" autocomplete="off" spellcheck="false" name="unit_item[]" id="<?php echo 'unit_item'.($iter+1); ?>" rel="<?php echo 'rel_unit_item'.($iter+1); ?>" placeholder="Unit" value="<?php echo $row->unit; ?>" />
                                          </div>
                                          <div class=".col-6 .col-lg-4" style="margin-left: 16px; margin-top: 5px;">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm">
                                    <div class="row">
                                      <div class=".col-12 .col-sm-6 .col-lg-8">
                                        <input type="text" class="form-control" autocomplete="off" spellcheck="false" name="unit_kelengkapan[]" id="unit_kelengkapan1" rel="rel_unit_kelengkapan1" placeholder="Unit" value="<?php echo $row->unit;?>"/>
                                      </div>
                                      <div class=".col-6 .col-lg-4" style="margin-left: 16px; margin-top: 5px;">
                                ...
                                <div class="col-md-3">
                                  <div class="form-group">
                                    <div class="col-sm">
                                      <div class="row">
                                        <div class=".col-12 .col-sm-6 .col-lg-8">
                                          <input type="text" class="form-control" autocomplete="off" spellcheck="false" name="unit_kelengkapan[]" id="unit_kelengkapan'+counterA+'" rel="rel_unit_kelengkapan'+counterA+'" placeholder="Unit" value="<?php echo $row->unit; ?>" />
                                        </div>
                                        <div class=".col-6 .col-lg-4" style="margin-left: 16px; margin-top: 5px;">
        ...
        $(document).ready(function(){
          ...
          $("#add_kelengkapan").on("click", function(e) {
            ...
            '<div class="col-md-4">'+
              '<div class="form-group">'+
                '<div class="col-sm">'+
                  '<input type="text" class="form-control name-kelengkapan" autocomplete="off" spellcheck="false" name="name_kelengkapan[]" id="name_kelengkapan'+counterA+'" rel="rel_name_kelengkapan'+counterA+'" placeholder="Name Item" value="<?php //echo $kelengkapan_name; ?>" required />'+
                '</div>'+
              '</div>'+
            '</div>'+
            ...
            '<div class="col-md-2">'+
              '<div class="form-group">'+
                '<div class="col-sm">'+
                  '<input type="number" class="form-control name-kelengkapan" autocomplete="off" spellcheck="false" name="price_kelengkapan[]" id="price_kelengkapan'+counterA+'" rel="rel_price_kelengkapan'+counterA+'" placeholder="Price Item" value="<?php //echo $kelengkapan_name; ?>" required />'+
                '</div>'+
              '</div>'+
            '</div>'+
            ...
            '<div class="col-md-2">'+
              '<div class="form-group">'+
                '<div class="col-sm">'+
                  '<input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_kelengkapan[]" id="qty_kelengkapan'+counterA+'" rel="rel_qty_kelengkapan'+counterA+'" placeholder="Qty" value="<?php //echo $kelengkapan_qty; ?>" required />'+
                '</div>'+
              '</div>'+
          ...
          $("#add_item").on("click", function(e) {
            ...
            var html_list = '';
            html_list += 
            '<div><div class="row"><div class="col-2">' +
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="text" class="form-control name-item" autocomplete="off" spellcheck="false" name="name_item[]" id="name_item'+counterB+'" rel="rel_name_item'+counterB+'" placeholder="Name Item" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="col-2">' +
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="text" class="form-control nomesin-item" spellcheck="false" name="nomesin_item[]" id="nomesin_item'+counterB+'" rel="rel_nomesin_item'+counterB+'" placeholder="No. Mesin" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
             ...
             '<div class="col-2">' +
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="text" class="form-control norangka-item" spellcheck="false" name="norangka_item[]" id="norangka_item'+counterB+'" rel="rel_norangka_item'+counterB+'" placeholder="No. Mesin" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="col-2">' +
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="number" class="form-control name-item" autocomplete="off" spellcheck="false" name="price_item[]" id="price_item'+counterB+'" rel="rel_price_item'+counterB+'" placeholder="Price Item" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="col-1">' +
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_item[]" id="qty_item'+counterB+'" rel="rel_qty_item'+counterB+'" placeholder="Qty" value="1" />' +
                '</div>' +
              '</div>' +
          ...
          $("#add_other").on("click", function(e) {
            ...
            html_list += '<div><div class="row">'+
              '<div class="col-md-4">'+
                '<div class="form-group">'+
                  '<div class="col-sm">'+
                    '<input type="text" class="form-control name-other" autocomplete="off" spellcheck="false" name="name_other[]" id="name_other'+counterC+'" rel="rel_name_other'+counterC+'" placeholder="Name Item" value="<?php //echo $other_name; ?>" required/>'+
                  '</div>'+
                '</div>'+
              '</div>'+
              ...
              '<div class="form-group">' +
                '<div class="col-sm">' +
                  '<input type="number" class="form-control name-item" autocomplete="off" spellcheck="false" name="price_other[]" id="price_other'+counterB+'" rel="rel_price_other'+counterB+'" placeholder="Price Other" value="<?php //echo $item_name; ?>" required/>' +
                '</div>' +
              '</div>' +
            '</div>' +
              ...
              '<div class="col-md-2">'+
                '<div class="form-group">'+
                  '<div class="col-sm">'+
                    '<input type="number" class="form-control" autocomplete="off" spellcheck="false" name="qty_other[]" id="qty_other'+counterC+'" rel="rel_qty_other'+counterC+'" placeholder="Qty" value="<?php //echo $other_qty; ?>" required/>'+
                  '</div>'+
                '</div>'+
              ...
              '<div class="col-md-3">'+
                '<div class="form-group">'+
                  '<div class="col-sm">'+
                   '<div class="row">'+
                      '<div class=".col-12 .col-sm-6 .col-lg-8">'+
                        '<input type="text" class="form-control" autocomplete="off" spellcheck="false" name="unit_other[]" id="unit_other'+counterC+'" rel="rel_unit_other'+counterC+'" placeholder="Unit" value="<?php //echo $other_unit; ?>" required/>'+
                      '</div>'+
                      '<div class=".col-6 .col-lg-4" style="margin-left: 16px; margin-top: 5px;">'+
                        '<a href="" id="remove_other"><i class="far fa-times-circle"></i></a>'+
                      '</div>'+

        ...
        function data_range(first,last){
                  ...
                  "columns": [
                      ...
                      { "data": null,
                        render: function ( data, type, row ) {
                          ...
                          '<div class="btn-group" role="group" aria-label="Third group">'+
                            '<button id="print-invoice" title="Print Invoice" style="margin-left: 5px;" class="btn btn-primary btn-sm"><i class="fas fa-file-invoice-dollar"></i></i></button></div>'+  
                          '<div class="btn-group" role="group" aria-label="Third group">'+
              ...
              $('#mytable').on( 'click', '#print-kirim', function (e) {
               ...
               $('#mytable').on( 'click', '#print-invoice', function (e) {
                e.preventDefault();
                var data = table.row( $(this).parents('tr') ).data();
                  if (data != null) {
                    window.open('<?php echo base_url()?>index.php/delivery/pdfInvoice/'+data.kode,'_blank');
                  }
              } );
              ...
              $('#mytable').on( 'click', '#delete', function (e) {
                e.preventDefault();
                  ...
                  if (data != null) {
                    swal({
                      title: "Confirmation",
                      text: "Are your sure want to delete Delivery No."+data.kode + "/" + data.bulan + "/" + data.tahun+ " ?",
                      icon: "warning",
                      buttons: true,
                      dangerMode: true,
                    })

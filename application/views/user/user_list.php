                ...
                <table class="table table-bordered table-striped" style="width:100%;" id="mytable">
                    <thead>
                        <tr>
                			...
                			echo '  '; 
                			echo anchor(site_url('index.php/user/update/'.$user->id),'<i class="fas fa-edit"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm')); 
                			echo '  '; 
                			echo anchor(site_url('index.php/user/delete/'.$user->id),'<i class="fas fa-trash-alt"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                			?>
                		    </td>
                	        </tr>
                        <?php

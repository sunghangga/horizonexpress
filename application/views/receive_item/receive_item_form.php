<!-- Main content -->
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Delivery Detail Id <?php echo form_error('delivery_detail_id') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="delivery_detail_id" id="delivery_detail_id" placeholder="Delivery Detail Id" value="<?php echo $delivery_detail_id; ?>" />
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Qty Received <?php echo form_error('qty_received') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="qty_received" id="qty_received" placeholder="Qty Received" value="<?php echo $qty_received; ?>" />
                                   </div> 
                                </div>

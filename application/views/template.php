...
<div class="wrapper">
                    ...
                    <li class="user-footer">
                        <div class="row">
                            <div class="pull-left col-md-6">
                                <?php
                                echo anchor(base_url('index.php/user/profil'),'Profil',array('class'=>'btn btn-default btn-flat'));
                                ?>
                            </div>
                            <div class="pull-right col-md-6" style="text-align: right;">
                                <?php
                                echo anchor(base_url('index.php/login/logout'),'Sign out',array('class'=>'btn btn-default btn-flat'));
                                ?>
                            </div>
                        </div>
                    </li>
  ...
  <aside class="main-sidebar sidebar-light-danger elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('index.php/beranda') ?>" class="brand-link bg-red">
      <img src="<?php echo base_url() ?>template/dist/img/logo-white.png" alt="AdminLTE Logo" class="brand-image"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><b>Horizon</b> Express</span>
    </a>
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fas fa-shipping-fast"></i>
              <p>
                Delivery
            ...
            <ul class="nav nav-treeview"> 
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/tracking') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tracking</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fas fa-bookmark"></i>
              <p>
                Items
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/item') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Items</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/truck') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Truck</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/tire') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tire</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/tire_in') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tire In</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/tire_out') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tire Out</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/driver') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Driver</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('index.php/group') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Group</p>
                </a>
              </li>

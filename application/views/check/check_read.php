<!-- Main content -->
	 ...
	 <div style='text-align: right;'>
        ...
        <script>
          window.onload = function show_data(){
                  ...
                  var i;
                            ...
                            '<div class="modal-content">'+
                              ...
                              '<div class="modal-body">'+
                                  ...
                                  '<div class="form-group">'+
                                    ...
                                    '<input type="text" class="form-control" id="gejala_item'+data[i].id+iter.toString()+'" name="gejala_item[]" value="'+data[i].gejala+'" disabled/>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Penyebab</label>'+
                                    '<input type="text" class="form-control" id="penyebab_item'+data[i].id+iter.toString()+'" name="penyebab_item[]" value="'+data[i].penyebab+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Engine</label>'+
                                    '<input type="text" class="form-control" id="engine_item'+data[i].id+iter.toString()+'" name="engine_item[]" value="'+data[i].engine+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Frame</label>'+
                                    '<input type="text" class="form-control" id="frame_item'+data[i].id+iter.toString()+'" name="frame_item[]" value="'+data[i].frame+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Type</label>'+
                                    '<input type="text" class="form-control" id="type_item'+data[i].id+iter.toString()+'" name="type_item[]" value="'+data[i].type+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Solusi dari Dealer</label>'+
                                    '<input type="text" class="form-control" id="solusi_item'+data[i].id+iter.toString()+'" name="solusi_item[]" value="'+data[i].solusi+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="message-text" class="col-form-label">Keterangan</label>'+
                                    '<textarea class="form-control" id="keterangan_item'+data[i].id+iter.toString()+'" name="keterangan_item[]" disabled>'+data[i].keterangan+'</textarea>'+
                                  '</div>'+
                              '</div>'+
                    ...
                    for (var i = 0; i < data.length; i++) {
                      ...
                      '<div class="form-group">';
                        ...
                        '<input type="hidden" class="form-control" name="id_detail[]" value="'+data[i].id+'"/>'+
                          '<input type="text" class="form-control name-kelengkapan" autocomplete="off" spellcheck="false" name="name_item[]" id="name_kelengkapan'+data[i].id+iter.toString()+'" rel="rel_name_kelengkapan1" placeholder="Name Item" value="'+data[i].name+'" disabled/>'+
                        '</div>'+
                      '</div>'+
                    '</div>';
                          ...
                          '<div class="modal-dialog" role="document">'+
                            '<div class="modal-content">'+
                              ...
                              '<div class="modal-body">'+
                                  ...
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Gejala</label>'+
                                    '<input type="text" class="form-control" id="gejala_kelengkapan'+data[i].id+iter.toString()+'" name="gejala_item[]" value="'+data[i].gejala+'" disabled/> '+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Penyebab</label>'+
                                    '<input type="text" class="form-control" id="penyebab_kelengkapan'+data[i].id+iter.toString()+'" name="penyebab_item[]" value="'+data[i].penyebab+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Engine</label>'+
                                    '<input type="text" class="form-control" id="engine_kelengkapan'+data[i].id+iter.toString()+'" name="engine_item[]" value="'+data[i].engine+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Frame</label>'+
                                    '<input type="text" class="form-control" id="frame_kelengkapan'+data[i].id+iter.toString()+'" name="frame_item[]" value="'+data[i].frame+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Type</label>'+
                                    '<input type="text" class="form-control" id="type_kelengkapan'+data[i].id+iter.toString()+'" name="type_item[]" value="'+data[i].type+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Solusi dari Dealer</label>'+
                                    '<input type="text" class="form-control" id="solusi_kelengkapan'+data[i].id+iter.toString()+'" name="solusi_item[]" value="'+data[i].solusi+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="message-text" class="col-form-label">Keterangan</label>'+
                                    '<textarea class="form-control" id="keterangan_kelengkapan'+data[i].id+iter.toString()+'" name="keterangan_item[]" disabled>'+data[i].keterangan+'</textarea>'+
                                  '</div>'+
                              '</div>'+
                              '<div class="modal-footer">'+
                                '<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>'+
                    ...
                    for (var i = 0; i < data.length; i++) { 
                      ...
                      '<div class="form-group">';
                        ...
                        html += '<div class="col-sm">'+
                        '<input type="hidden" class="form-control" name="id_detail[]" value="'+data[i].id+'"/>'+
                          '<input type="text" class="form-control name-other" autocomplete="off" spellcheck="false" name="name_item[]" id="name_other'+data[i].id+iter.toString()+'" rel="rel_name_other1" placeholder="Name Item" value="'+data[i].name+'" disabled/>'+ 
                        '</div>'+
                      '</div>'+ 
                    '</div>'; 
                          ...
                          '<div class="modal-dialog" role="document">'+
                            '<div class="modal-content">'+
                              ...
                              '<div class="modal-body">'+
                                  ...
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Gejala</label>'+
                                    '<input type="text" class="form-control" id="gejala_other'+data[i].id+iter.toString()+'" name="gejala_item[]" value="'+data[i].gejala+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Penyebab</label>'+
                                    '<input type="text" class="form-control" id="penyebab_other'+data[i].id+iter.toString()+'" name="penyebab_item[]" value="'+data[i].penyebab+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Engine</label>'+
                                    '<input type="text" class="form-control" id="engine_other'+data[i].id+iter.toString()+'" name="engine_item[]" value="'+data[i].engine+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">No. Frame</label>'+
                                    '<input type="text" class="form-control" id="frame_other'+data[i].id+iter.toString()+'" name="frame_item[]" value="'+data[i].frame+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Type</label>'+
                                    '<input type="text" class="form-control" id="type_other'+data[i].id+iter.toString()+'" name="type_item[]" value="'+data[i].type+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="recipient-name" class="col-form-label">Solusi dari Dealer</label>'+
                                    '<input type="text" class="form-control" id="solusi_other'+data[i].id+iter.toString()+'" name="solusi_item[]" value="'+data[i].solusi+'" disabled>'+
                                  '</div>'+
                                  '<div class="form-group">'+
                                    '<label for="message-text" class="col-form-label">Keterangan</label>'+
                                    '<textarea class="form-control" id="keterangan_other'+data[i].id+iter.toString()+'" name="keterangan_item[]" disabled>'+data[i].keterangan+'</textarea>'+
                                  '</div>'+
                              '</div>'+
                              '<div class="modal-footer">'+
                                '<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>'+

                    ...
                    <div class='row'>
                      <div class='col-12'>
                          <form action="<?php echo $action; ?>" method="post">
                                ...
                                <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Username <?php echo form_error('name') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="username" id="username" placeholder="Username" value="<?php echo $username; ?>" />
                                   </div> 
                                </div>
                                <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Password <?php echo form_error('password') ?></label>
                                    <div class='col-sm-10'><input type="password" class="form-control" name="password" id="password" placeholder="Password" value="<?php echo $password; ?>" />
                                   </div> 
                                </div>

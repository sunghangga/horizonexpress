<!-- Main content -->
	  ...
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>First District Id <?php echo form_error('first_district_id') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="first_district_id" id="first_district_id" placeholder="First District Id" value="<?php echo $first_district_id; ?>" disabled/>
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Last District Id <?php echo form_error('last_district_id') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="last_district_id" id="last_district_id" placeholder="Last District Id" value="<?php echo $last_district_id; ?>" disabled/>
                                   </div> 
                                </div>
	  <div class='form-group row'><label for='label' class='col-sm-2 col-form-label'>Emount <?php echo form_error('emount') ?></label>
                                    <div class='col-sm-10'><input type="text" class="form-control" name="emount" id="emount" placeholder="Emount" value="<?php echo $emount; ?>" disabled/>
                                   </div> 
                                </div>
